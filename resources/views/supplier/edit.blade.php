    ...
    <div class="card mt-2">
      <div class="card-body">
        <form action="/supplier/update" method="post">
          ...
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Kode Supplier" placeholder="Kode Supplier" value="{{$supplier->kode_supplier}}"
          ...
          <div class="rom mb-2">
            <x-inputtextarea label="Alamat" field="alamat_supplier" value="{{$supplier->alamat_supplier}}" />
          </div>
          <div class="row mb-2">
            <div class="col-md-12">
