    ...
    <div class="card mt-2">
      <div class="card-body">
        <form action="/produk/store" method="post">
          ...
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Kode Produk" placeholder="Kode Produk" value={{$kode_produk}} field="kode_produk"
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Nama Produk" placeholder="Nama Produk" field="nama_produk" icon='
            ...
            <div class="col-md-6">
              ...
              <div class="form-group  @error('id_kategori') is-invalid @enderror">
                <select name="id_kategori" id="id_kategori"
                  ...
                  <option {{old('id_spesialis')==$p->id_kategori ? 'selected':''}} value="{{$p->id_kategori}}">
                    {{$p->kategori}}
                  </option>
                  @endforeach
                </select>
            ...
            <div class="col-md-6">
              ...
              <div class="form-group  @error('id_satuan') is-invalid @enderror">
                <select name="id_satuan" id="id_satuan" class="form-select  @error('id_satuan') is-invalid @enderror">
                  ...
                  @foreach ($satuan as $p)
                  <option {{old('id_satuan')==$p->id_satuan ? 'selected':''}} value="{{$p->id_satuan}}">
                    {{$p->satuan}}
                  </option>
                  @endforeach
                </select>
          ...
          <div class="rom mb-2">
            <x-inputtextarea label="Deskripsi" field="deskripsi" />
          </div>
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Minimal Stock" placeholder="Minimal Stock" field="min_stock" icon='
                <svg xmlns=" http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24"
                stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                <polyline points="12 3 20 7.5 20 16.5 12 21 4 16.5 4 7.5 12 3" />
          ...
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Harga Beli" placeholder="Harga Beli" field="harga_beli" style="text-align:right" icon='
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Barcode" placeholder="Barcode" field="barcode" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2'
                stroke='currentColor' fill='none' stroke-linecap='round' stroke-linejoin='round'>
                <path stroke='none' d='M0 0h24v24H0z' fill='none' />
                <path d='M4 7v-1a2 2 0 0 1 2 -2h2' />
                <path d='M4 17v1a2 2 0 0 0 2 2h2' />
