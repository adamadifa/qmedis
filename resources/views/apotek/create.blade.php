    ...
    <div class="card mt-2">
      <div class="card-body">
        <form action="/apotek/store" method="post">
          ...
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Kode Apotek" placeholder="Kode Apotek" value={{$kode_apotek}} field="kode_apotek"
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="SIA" placeholder="SIA" field="sia_no"
                icon='
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Apoteker" placeholder="Apoteker" field="apoteker"
                icon='
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Pemilik" placeholder="Pemilik" field="pemilik"
                icon='
                <!-- Download SVG icon from http://tabler-icons.io/i/user -->
	              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="7" r="4" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>' />
            </div>
