...
<div class="row">
  <div class="col-md-6">
    <div class="card mt-2">
      <div class="card-body">
        <form action="/apotek/update" method="post">
          @csrf
          <div class="row mb-2">
            <div class="col-md-4">
              <x-inputtext label="Kode Apotek" placeholder="Kode Apotek" value="{{$apotek->kode_apotek}}"
                field="kode_apotek" readonly="true" icon="<svg xmlns='http://www.w3.org/2000/svg' class='icon' width='24' height='24' viewBox='0 0 24 24' stroke-width='2'
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Nama Apotek" placeholder="Nama Apotek" field="nama_apotek"
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="SIA" placeholder="SIA" field="sia_no" value="{{$apotek->sia_no}}"
                icon='
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Apoteker" placeholder="Apoteker" field="apoteker" value="{{$apotek->apoteker}}"
                icon='
          ...
          <div class="row mb-2">
            <div class="col-md-12">
              <x-inputtext label="Pemilik" placeholder="Pemilik" field="pemilik" value="{{$apotek->pemilik}}"
                icon='
                <!-- Download SVG icon from http://tabler-icons.io/i/user -->
	              <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><circle cx="12" cy="7" r="4" /><path d="M6 21v-2a4 4 0 0 1 4 -4h4a4 4 0 0 1 4 4v2" /></svg>' />
            </div>
          ...
          <div class="rom mb-2">
            <x-inputtextarea label="Alamat" field="alamat" value="{{$apotek->alamat}}" />
          </div>

          <div class="row mb-2">
            <div class="col-md-6">
              <x-inputtext label="No Telepon" placeholder="No Telepon" field="no_telepon"
                value="{{$apotek->no_telepon}}"
