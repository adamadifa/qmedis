    ...
    <div class="card mt-2">
      <div class="card-body">
        <div class="d-flex justify-content-between">
          ...
          <div>
            <a href="/kategori/create" class="btn btn-primary d-none d-sm-inline-block mb-3">
              ...
              <tr>
                ...
                <td>
                  <div class="grid-container">
                    <div class="grid-item">
                      <a href="/kategori/{{$d->id_kategori}}/edit" class="btn btn-sm btn-primary"><i
                          class="fa fa-pencil"></i></a>
                    </div>
                    <div class="grid-item">
                      <form action="/kategori/{{$d->id_kategori}}/delete" id="deleteform" method="post">
                        @csrf
                        @method('DELETE')
